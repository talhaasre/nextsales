...
function include_assets()
{
	...
	wp_enqueue_script('swiper', "https://cdnjs.cloudflare.com/ajax/libs/Swiper/8.4.7/swiper-bundle.min.js");
	wp_enqueue_script('countup', "https://cdn.jsdelivr.net/npm/countup@1.8.2/countUp.js");
